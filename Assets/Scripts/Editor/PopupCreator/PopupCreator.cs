...
public class PopupCreator : EditorWindow
{
    ...
    private List<GameObject> FindAllPopups()
    {
        ...
        foreach (string guid in prefabGuids)
        {
            ...
            if (prefab.GetComponent<BaseWindow>() != null)
            {
    ...
    public void RegisterInUIServiceViewContainer(GameObject prefabAsset)
    {
        ...
        BaseWindow baseWindowComponent = prefabAsset.GetComponent<BaseWindow>();
        ...
        popupsPrefabProperty.GetArrayElementAtIndex(popupsPrefabProperty.arraySize - 1).objectReferenceValue = baseWindowComponent;
