    ...
    public class EazySoundManager : MonoBehaviour
    {
        ...
        private static void UpdateAllAudio(Dictionary<int, Audio> audioDict)
        {
            ...
            foreach (int key in keys)
            {
                ...
                {
                    //this deletes audio source when closing/reopening the app
        ...
        #region IsPlaying Functions 
        
        /// <summary>
        /// Checks if any audio with the given ID is currently playing
        /// </summary>
        public static bool IsPlaying(int audioID)
        {
        ...
        /// <summary>
        /// Checks if any audio with the given audio clip is currently playing
        /// </summary>
        public static bool IsPlaying(AudioClip audioClip)
        {
            Audio audio = GetAudio(audioClip);
            return audio != null && audio.IsPlaying;
        }

        /// <summary>
        /// Checks if the music with given ID is currently playing
        /// </summary>
        public static bool IsMusicPlaying(int audioID)
        {
        ...
        /// <summary>
        /// Checks if any music with the given audio clip is currently playing
        /// </summary>
        public static bool IsMusicPlaying(AudioClip audioClip)
        {
            Audio audio = GetMusicAudio(audioClip);
            return audio != null && audio.IsPlaying;
        }
        ...
        /// <summary>
        /// Checks if the sound with given ID is currently playing
        /// </summary>
        public static bool IsSoundPlaying(int audioID)
        {
            Audio audio = GetSoundAudio(audioID);
            return audio != null && audio.IsPlaying;
        }

        /// <summary>
        /// Checks if any sound with the given audio clip is currently playing
        /// </summary>
        public static bool IsSoundPlaying(AudioClip audioClip)
        {
            Audio audio = GetSoundAudio(audioClip);
            return audio != null && audio.IsPlaying;
        }

        /// <summary>
        /// Checks if the UI sound with given ID is currently playing
        /// </summary>
        public static bool IsUISoundPlaying(int audioID)
        {
            Audio audio = GetUISoundAudio(audioID);
            return audio != null && audio.IsPlaying;
        }

        /// <summary>
        /// Checks if any UI sound with the given audio clip is currently playing
        /// </summary>
        public static bool IsUISoundPlaying(AudioClip audioClip)
        {
            Audio audio = GetUISoundAudio(audioClip);
            return audio != null && audio.IsPlaying;
        }
